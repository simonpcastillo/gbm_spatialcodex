...
data_pcf %>%
  ...
  group_by(tempid) %>%
  summarise(mGmean10= mean(Gmean10),
            mGmean30= mean(Gmean30),
            mGmean50= mean(Gmean50),
...
data_pcf2 %>%
  dplyr::select(sample, region, path_region, pair, cell1, cell2, mGmean10,mGmean30 ,mGmean50, mGmean100) -> data_pcf2
